...
\begin{solution}
Przedewszystkim pełni rolę zabezpieczenia przed edycją dokumentu który jest przez nią podpisany. Dzieje się tak ponieważ definicja dobrej funkcji hashującej zapewnia nam iż zmiana nawet jednego znaku w dokumencie da nam zupełne nowy i  unikalny hash. 
\end{solution}
